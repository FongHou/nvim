...
inoremap <buffer><silent><C-x><C-i>  <Left><C-o>:HaskComplete import <C-r>=expand('<cexpr>')<CR><CR><Right>
inoremap <buffer><silent><C-x><C-j>  <Left><C-o>:HaskComplete <C-r>=expand('<cexpr>')<CR><CR><Right>
